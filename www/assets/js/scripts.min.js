...
};var old=$.fn.tab;$.fn.tab=function(option){return this.each(function(){var $this=$(this),data=$this.data("bs.tab");data||$this.data("bs.tab",data=new Tab(this)),"string"==typeof option&&data[option]()})},$.fn.tab.Constructor=Tab,$.fn.tab.noConflict=function(){return $.fn.tab=old,this},$(document).on("click.bs.tab.data-api",'[data-toggle="tab"], [data-toggle="pill"]',function(e){e.preventDefault(),$(this).tab("show")})}(jQuery),+function($){"use strict";var Affix=function(element,options){this.options=$.extend({},Affix.DEFAULTS,options),this.$window=$(window).on("scroll.bs.affix.data-api",$.proxy(this.checkPosition,this)).on("click.bs.affix.data-api",$.proxy(this.checkPositionWithEventLoop,this)),this.$element=$(element),this.affixed=this.unpin=this.pinnedOffset=null,this.checkPosition()};Affix.RESET="affix affix-top affix-bottom",Affix.DEFAULTS={offset:0},Affix.prototype.getPinnedOffset=function(){if(this.pinnedOffset)return this.pinnedOffset;this.$element.removeClass(Affix.RESET).addClass("affix");var scrollTop=this.$window.scrollTop(),position=this.$element.offset();return this.pinnedOffset=position.top-scrollTop},Affix.prototype.checkPositionWithEventLoop=function(){setTimeout($.proxy(this.checkPosition,this),1)},Affix.prototype.checkPosition=function(){if(this.$element.is(":visible")){var scrollHeight=$(document).height(),scrollTop=this.$window.scrollTop(),position=this.$element.offset(),offset=this.options.offset,offsetTop=offset.top,offsetBottom=offset.bottom;"top"==this.affixed&&(position.top+=scrollTop),"object"!=typeof offset&&(offsetBottom=offsetTop=offset),"function"==typeof offsetTop&&(offsetTop=offset.top(this.$element)),"function"==typeof offsetBottom&&(offsetBottom=offset.bottom(this.$element));var affix=null!=this.unpin&&scrollTop+this.unpin<=position.top?!1:null!=offsetBottom&&position.top+this.$element.height()>=scrollHeight-offsetBottom?"bottom":null!=offsetTop&&offsetTop>=scrollTop?"top":!1;if(this.affixed!==affix){this.unpin&&this.$element.css("top","");var affixType="affix"+(affix?"-"+affix:""),e=$.Event(affixType+".bs.affix");this.$element.trigger(e),e.isDefaultPrevented()||(this.affixed=affix,this.unpin="bottom"==affix?this.getPinnedOffset():null,this.$element.removeClass(Affix.RESET).addClass(affixType).trigger($.Event(affixType.replace("affix","affixed"))),"bottom"==affix&&this.$element.offset({top:scrollHeight-offsetBottom-this.$element.height()}))}}};var old=$.fn.affix;$.fn.affix=function(option){return this.each(function(){var $this=$(this),data=$this.data("bs.affix"),options="object"==typeof option&&option;data||$this.data("bs.affix",data=new Affix(this,options)),"string"==typeof option&&data[option]()})},$.fn.affix.Constructor=Affix,$.fn.affix.noConflict=function(){return $.fn.affix=old,this},$(window).on("load",function(){$('[data-spy="affix"]').each(function(){var $spy=$(this),data=$spy.data();data.offset=data.offset||{},data.offsetBottom&&(data.offset.bottom=data.offsetBottom),data.offsetTop&&(data.offset.top=data.offsetTop),$spy.affix(data)})})}(jQuery);var myApp=angular.module("myApp",["ngRoute","ngResource","LocalStorageModule","ngSanitize","google-maps","angular-websql"]);myApp.config(["localStorageServiceProvider",function(localStorageServiceProvider){localStorageServiceProvider.setPrefix("bonoway")}]),myApp.controller("mainController",function($scope,localStorageService,$location){$scope.title="Homepage",$scope.message="home",$scope.isActive=function(viewLocation){return viewLocation===$location.path()},localStorageService.clearAll(),localStorageService.set("site.1",'{ "id":1,"name": "Fenouillet", "latitude": 43.136443, "longitude": 6.098854, "couv": "fenouillet.jpg", "description": "Le spot de bloc toulonnais! Dans la foret des colines qui dominent Hyeres, le site offre de jolie bloc en gneiss bien compact. A l ombre des arbres et donc souvent humide aussi.", "tag": "#toulon #gneiss", "volume": "13"}'),localStorageService.set("site.2",'{ "id":2,"name": "Gordolasque", "latitude": 44.075890, "longitude": 7.401487, "couv": "gordolasque.jpg", "descritpion": "Dans la vallee de la gordolasque, la fin de la route se termine par un chaos de beaux blocs parfois haut. Le cadre magique du debut du parc du Mercantour et magique! Frais en été et froid en hiver le site et parfait pour fuire la foule et les chaleurs de la cote.", "tag": "#montagne #mercantour #bellevedere #gneiss", "volume": "4"}'),localStorageService.set("site.3",'{ "id":3,"name": "Roquebrune", "latitude": 43.457493, "longitude": 6.597758, "couv": "roquebrune.jpg", "description": "Inevitable depuis l autoroute, le rocher de roqueburne atire l oeil. Sur les flancs de la montagne on touve de nobreuses boules de conglomérat rouge. Faute de pouvoir équiper les falaises qui les suplombent, la quantité de bloc est impressionante et le site est en pleine expension.", "tag": "#conglomerat #ermite", "volume": "15"}'),localStorageService.set("parking.1",'{ "id":1, "latitude": 43.135942, "longitude": 6.098633, "site": "1"}'),localStorageService.set("parking.2",'{ "id":2, "latitude": 43.458484, "longitude": 6.603060, "site": "2"}'),localStorageService.set("parking.3",'{ "id":3, "latitude": 44.073823, "longitude": 7.400043, "site": "3"}'),localStorageService.set("sector.1",'{ "id":1,"name": "Squamish", "latitutde": 43.136826, "longitude": 6.096699, "approach": "15min", "site": "1"}'),localStorageService.set("sector.2",'{ "id":2,"name": "Parking", "latitude": 43.136145, "longitude": 6.099227, "approach": "15min", "site": "1"}'),localStorageService.set("sector.3",'{ "id":3,"name": "Espigoule", "latitude": 43.138010, "longitude": 6.102571, "approach": "15min", "site": "1"}'),localStorageService.set("sector.4",'{ "id":4,"name": "Parking", "latitude": 44.074160, "longitude": 7.400161, "approach": "15min", "site": "2"}'),localStorageService.set("sector.5",'{ "id":5,"name": "Chaos", "latitude": 44.077724, "longitude": 7.401964, "approach": "15min", "site": "2"}'),localStorageService.set("sector.6",'{ "id":6,"name": "Cascade", "latitude": 43.455697, "longitude": 6.601392, "approach": "15min", "site": "3"}'),localStorageService.set("sector.7",'{ "id":7,"name": "Chapelle", "latitude": 43.458971, "longitude": 6.592596, "approach": "15min", "site": "3"}'),localStorageService.set("line.1",'{ "id":1,"name": "Pose ton cul","latitude": 43.136826, "longitude": 6.096699, "images": ["1.jpg", "2.jpg"], "grade": "7a", "site": "1", "sector": "1"}'),localStorageService.set("line.2",'{ "id":2,"name": "La force tranquille", "latitude": 43.136826, "longitude": 6.096699, "images": ["1.jpg"], "grade": "7a+", "site": "1", "sector": "1"}'),localStorageService.set("line.3",'{ "id":3,"name": "Put your ass", "latitude": 43.136826, "longitude": 6.096699, "images": ["1.jpg"], "grade": "7a+", "site": "1", "sector": "1"}'),localStorageService.set("line.4",'{ "id":4,"name": "Lili", "latitude": 43.136826, "longitude": 6.096699, "grade": "7b+", "images": "1.jpg", "site": "1", "sector": "1"}'),localStorageService.set("line.5",'{ "id":5,"name": "Orange and grey", "latitude": 43.136826, "longitude": 6.096699, "images": "1.jpg", "grade": "7a+", "site": "1", "sector": "1"}'),localStorageService.set("line.6",'{ "id":6,"name": "Pulpe friction", "latitude": 43.136145, "longitude": 6.099227, "images": "1.jpg", "grade": "7a+", "site": "1", "sector": "2"}'),localStorageService.set("line.7",'{ "id":7,"name": "Big traverse", "latitude": 43.136145, "longitude": 6.099227, "images": "1.jpg", "grade": "7a", "site": "1", "sector": "2"}'),localStorageService.set("line.8",'{ "id":8,"name": "N33", "latitude": 43.136145, "longitude": 6.099227, "images": "1.jpg", "grade": "6a", "site": "1", "sector": "2"}'),localStorageService.set("line.9",'{ "id":9,"name": "N30", "latitude": 43.136145, "longitude": 6.099227, "images": "1.jpg", "grade": "6b", "site": "1", "sector": "2"}'),localStorageService.set("line.10",'{ "id":10,"name": "N32", "latitude": 43.136145, "longitude": 6.099227, "images": "1.jpg", "grade": "6b", "site": "1", "sector": "2"}'),localStorageService.set("line.11",'{ "id":11,"name": "Le zèbre", "latitude": 43.138010, "longitude": 6.102571, "grade": "7b", "site": "1", "sector": "3"}'),localStorageService.set("line.12",'{ "id":12,"name": "Le facomochère", "latitude": 43.138010, "longitude": 6.102571, "grade": "7a", "site": "1", "sector": "3"}'),localStorageService.set("line.13",'{ "id":13,"name": "Lart et la technique", "latitude": 43.138010, "longitude": 6.102571, "grade": "7a+", "site": "1", "sector": "3"}'),localStorageService.set("line.14",'{ "id":14,"name": "I am not down", "latitude": 44.074160, "longitude": 7.400161, "grade": "7a+", "site": "2", "sector": "4"}'),localStorageService.set("line.15",'{ "id":15,"name": "Hypo Canette", "latitude": 44.074160, "longitude": 7.400161, "grade": "7b+", "site": "2", "sector": "4"}'),localStorageService.set("line.16",'{ "id":16,"name": "Kick parade", "latitude": 44.077724, "longitude": 7.401964, "grade": "7a+", "site": "2", "sector": "5"}'),localStorageService.set("line.17",'{ "id":17,"name": "Canabis street", "latitude": 44.077724, "longitude": 7.401964, "grade": "7c", "site": "2", "sector": "5"}'),localStorageService.set("line.18",'{ "id":18,"name": "Zion", "latitude": 43.455697, "longitude": 6.601392, "images": ["1.jpg", "2.jpg"], "grade": "7b", "site": "3", "sector": "6"}'),localStorageService.set("line.19",'{ "id":19,"name": "Death in Vegas", "latitude": 43.455697, "longitude": 6.601392, "grade": "7b+", "site": "3", "sector": "6"}'),localStorageService.set("line.20",'{ "id":20,"name": "Fermeture éclair", "latitude": 43.455697, "longitude": 6.601392, "grade": "7c", "site": "3", "sector": "6"}'),localStorageService.set("line.21",'{ "id":21,"name": "Electric umbrella", "latitude": 43.455697, "longitude": 6.601392, "grade": "8a", "site": "3", "sector": "6"}'),localStorageService.set("line.22",'{ "id":22,"name": "Lavande sauvage", "latitude": 43.455697, "longitude": 6.601392, "grade": "7a", "site": "3", "sector": "6"}'),localStorageService.set("line.23",'{ "id":23,"name": "Bloc a bloc", "latitude": 43.455697, "longitude": 6.601392, "grade": "6c", "site": "3", "sector": "6"}'),localStorageService.set("line.24",'{ "id":24,"name": "La force de tenebres", "latitude": 43.455697, "longitude": 6.601392, "grade": "6c", "site": "3", "sector": "6"}'),localStorageService.set("line.25",'{ "id":25,"name": "Solitude", "latitude": 43.455697, "longitude": 6.601392, "grade": "6c+", "site": "3", "sector": "6"}'),localStorageService.set("line.26",'{ "id":26,"name": "La desmonta", "latitude": 43.458971, "longitude": 6.592596, "grade": "7b", "site": "3", "sector": "7"}'),localStorageService.set("line.27",'{ "id":27,"name": "Nonobstant", "latitude": 43.458971, "longitude": 6.592596, "grade": "7b", "site": "3", "sector": "7"}'),localStorageService.set("line.28",'{ "id":28,"name": "Chocapic", "latitude": 43.458971, "longitude": 6.592596, "grade": "7a+", "site": "3", "sector": "7"}'),localStorageService.set("line.29",'{ "id":29,"name": "La trav de Comete", "latitude": 43.458971, "longitude": 6.592596, "grade": "7a", "site": "3", "sector": "7"}'),localStorageService.set("line.30",'{ "id":30,"name": "Grand Bras", "latitude": 43.458971, "longitude": 6.592596, "grade": "7b+", "site": "3", "sector": "7"}'),localStorageService.set("line.31",'{ "id":31,"name": "Ls Iwork", "latitude": 43.458971, "longitude": 6.592596, "grade": "7c", "site": "3", "sector": "7"}'),localStorageService.set("line.32",'{ "id":32,"name": "Le tenia", "latitude": 43.458971, "longitude": 6.592596, "grade": "7b", "site": "3", "sector": "7"}')}),myApp.controller("SiteListCtrl",function($scope,$location,localStorageService){for($scope.title="Sites",$scope.message="page 1",$scope.sites=[],hasNext=!0,i=1;hasNext;)$scope.sites[i-1]=localStorageService.get("site."+i),i++,null===localStorageService.get("site."+i)&&(hasNext=!1);$scope.detail=function(siteId){$location.path("/site/"+siteId)}}),myApp.controller("SiteDetailCtrl",function($scope,$routeParams,$location,localStorageService){for(id=$routeParams.siteId,$scope.site=localStorageService.get("site."+id),$scope.sectors=[],hasNext=!0,i=1;hasNext;)sector=localStorageService.get("sector."+i),sector.site===id&&$scope.sectors.push(sector),i++,null===localStorageService.get("sector."+i)&&(hasNext=!1);for($scope.parkings=[],hasNext=!0,i=1;hasNext;)parking=localStorageService.get("parking."+i),sector.site===id&&$scope.parkings.push(parking),i++,null===localStorageService.get("parking."+i)&&(hasNext=!1);$scope.map={center:{latitude:$scope.site.latitude,longitude:$scope.site.longitude},zoom:16},$scope.lineList=function(siteId,sectorId){$location.path("/site/"+siteId+"/sector/"+sectorId)}}),myApp.controller("SectorCtrl",function($scope,$routeParams,$location,localStorageService){for(id=$routeParams.siteId,idd=$routeParams.sectorId,$scope.site=localStorageService.get("site."+id),$scope.currency=0===idd?"":idd,$scope.sectors=[],hasFollow=!0,j=1;hasFollow;)sector=localStorageService.get("sector."+j),sector.site===id&&(sector.id===idd&&(sector.check="selected"),$scope.sectors.push(sector)),j++,null===localStorageService.get("sector."+j)&&(hasFollow=!1);for($scope.lines=[],hasNext=!0,i=1;hasNext;)line=localStorageService.get("line."+i),line.site===id&&$scope.lines.push(line),i++,null===localStorageService.get("line."+i)&&(hasNext=!1);$scope.map={center:{latitude:$scope.site.latitude,longitude:$scope.site.longitude},zoom:16},$scope.maping=function(siteId,sectorId){$location.path("/site/"+siteId+"/map/"+sectorId)},$scope.listing=function(siteId,sectorId){$location.path("/site/"+siteId+"/sector/"+sectorId)},$scope.detail=function(lineId){$location.path("/line/"+lineId)},$scope.back=function(siteId){$location.path("/site/"+siteId)}}),myApp.controller("LineListCtrl",function($scope,$location,localStorageService){for($scope.title="Lines",$scope.message="Lines List",$scope.lines=[],hasNext=!0,i=1;hasNext;)$scope.lines[i-1]=localStorageService.get("line."+i),i++,null===localStorageService.get("line."+i)&&(hasNext=!1);for($scope.sites=[],hasNext=!0,j=1;hasNext;)$scope.sites[j]=localStorageService.get("site."+j),j++,null===localStorageService.get("site."+j)&&(hasNext=!1);$scope.detail=function(lineId){$location.path("/line/"+lineId)}}),myApp.controller("LineDetailCtrl",function($scope,$routeParams,$location,localStorageService){id=$routeParams.lineId,idSite=$routeParams.siteId,$scope.line=localStorageService.get("line."+id),$scope.site=localStorageService.get("site."+id),$scope.backSector=function(siteId,sectorId){$location.path("/site/"+siteId+"/sector/"+sectorId)}}),myApp.controller("addCtrl",function($scope,$location,localStorageService){for($scope.title="Ajout de blocs",$scope.message="En dévelopement",$scope.sites=[],hasNext=!0,i=1;hasNext;)$scope.sites[i]=localStorageService.get("site."+i),$scope.sites[i].type="site",i++,null===localStorageService.get("site."+i)&&(hasNext=!1);for($scope.sectors=[],hasNext=!0,i=1;hasNext;)$scope.sectors[i]=localStorageService.get("sector."+i),$scope.sectors[i].type="sector",i++,null===localStorageService.get("sector."+i)&&(hasNext=!1);$scope.myPictures=[],$scope.$watch("myPicture",function(value){value&&myPictures.push(value)},!0)}),myApp.controller("searchCtrl",function($scope,$location,localStorageService){for($scope.title="Search",$scope.message="En dévelopement",$scope.activeType="all",$scope.setSearchType=function(activeType){$scope.activeType=activeType},$scope.sites=[],hasNext=!0,i=1;hasNext;)$scope.sites[i-1]=localStorageService.get("site."+i),$scope.sites[i-1].type="site",i++,null===localStorageService.get("site."+i)&&(hasNext=!1);for($scope.lines=[],hasNext=!0,i=1;hasNext;)$scope.lines[i-1]=localStorageService.get("line."+i),currentsite=localStorageService.get("site."+$scope.lines[i-1].site),$scope.lines[i-1].sitename=currentsite.name,i++,null===localStorageService.get("line."+i)&&(hasNext=!1);$scope.detailSite=function(siteId){$location.path("/site/"+siteId)},$scope.detailLine=function(lineId){$location.path("/line/"+lineId)}}),myApp.controller("aboutCtrl",function($scope){$scope.title="A propos",$scope.message="Help page"}),myApp.config(["$routeProvider","$locationProvider",function($routeProvider,$locationProvider){$locationProvider.html5Mode(!1),$routeProvider.when("/",{templateUrl:"partials/default.html",controller:"mainController"}).when("/sites",{templateUrl:"partials/site/list.html",controller:"SiteListCtrl"}).when("/site/:siteId",{templateUrl:"partials/site/detail.html",controller:"SiteDetailCtrl"}).when("/site/:siteId/sector/:sectorId",{templateUrl:"partials/site/sector.html",controller:"SectorCtrl"}).when("/site/:siteId/map/:sectorId",{templateUrl:"partials/site/map.html",controller:"SectorCtrl"}).when("/lines",{templateUrl:"partials/line/list.html",controller:"LineListCtrl"}).when("/line/:lineId",{templateUrl:"partials/line/detail.html",controller:"LineDetailCtrl"}).when("/add",{templateUrl:"partials/add.html",controller:"addCtrl"}).when("/photo",{templateUrl:"partials/photo.html",controller:"photoCtrl"}).when("/search",{templateUrl:"partials/search.html",controller:"searchCtrl"}).when("/about",{templateUrl:"partials/about.html",controller:"aboutCtrl"}).otherwise({redirectTo:"/",controller:"mainController"})}]);